...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-13431604.183640, 3916812.866953, -13112545.536492, 4225036.297938], maxZoom: 28, minZoom: 5
    })
});
...
map.getView().fit([-13431604.183640, 3916812.866953, -13112545.536492, 4225036.297938], map.getSize());
